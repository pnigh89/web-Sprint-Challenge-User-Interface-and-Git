...
Semantic HTML is HTML code that meaningfully changes how the information contained within and between the tags behaves on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Block level elements start on a new line by default; inline do not. Block level elements take up the full width available by default; inline do not.
...
Allows for collaboration and versioning changes to the code.
